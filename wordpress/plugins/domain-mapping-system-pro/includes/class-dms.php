...
final class DMS {
	...
	/**
	 * Load premium__only dependencies
	 *
	 * @return void
	 */
	public function load_dependencies__premium_only(): void {
		/**
		 * Integrations
		 */
		require_once $this->plugin_dir_path . 'includes/integrations/seo/class-dms-seo__premium_only.php';
		require_once $this->plugin_dir_path . 'includes/integrations/seo/yoast/class-dms-seo-yoast__premium_only.php';
		require_once $this->plugin_dir_path . 'includes/integrations/wcfm/class-dms-wcfm__premium_only.php';
		/**
		 * Handlers
		 */
		require_once $this->plugin_dir_path . 'includes/frontend/handlers/class-dms-global-domain-mapping-handler__premium_only.php';
		require_once $this->plugin_dir_path . 'includes/frontend/handlers/class-dms-force-redirection-handler__premium_only.php';
		require_once $this->plugin_dir_path . 'includes/frontend/handlers/class-dms-favicon-handler__premium_only.php';
		require_once $this->plugin_dir_path . 'includes/frontend/handlers/class-dms-map-custom-html-handler__premium_only.php';

		/**
		 * Scenarios
		 */
		require_once $this->plugin_dir_path . 'includes/frontend/scenarios/class-dms-global-parent-mapping__premium_only.php';
		require_once $this->plugin_dir_path . 'includes/frontend/scenarios/class-dms-global-term-mapping__premium_only.php';
		require_once $this->plugin_dir_path . 'includes/frontend/scenarios/class-dms-short-child-mapping__premium_only.php';
		require_once $this->plugin_dir_path . 'includes/frontend/scenarios/class-dms-global-product-mapping__premium_only.php';
		require_once $this->plugin_dir_path . 'includes/frontend/scenarios/class-dms-shop-mapping__premium_only.php';
		require_once $this->plugin_dir_path . 'includes/frontend/scenarios/class-dms-wcfm-store-mapping__premium_only.php';
	}
	...
	public function define_admin_classes(): void {
		$this->admin = new Admin( $this->plugin_name, $this->plugin_dir_path, $this->plugin_dir_url, $this->version );
	}
	...
	public function define_frontend(): void {
		$this->frontend = Frontend::get_instance( $this->plugin_dir_url, $this->plugin_name, $this->version, $this->plugin_dir_path );
	}
	 ...
	 * @return void
	 */
	public function run_integrations__premium_only(): void {
		$active_plugins = (array) Setting::find( 'active_plugins' )->get_value();

		if ( in_array( 'wordpress-seo-premium/wp-seo-premium.php', $active_plugins, true ) ||
		     in_array( 'wordpress-seo/wp-seo.php', $active_plugins, true ) ) {
			Seo_Yoast::run();
		}
		if ( in_array('wc-multivendor-marketplace/wc-multivendor-marketplace.php', $active_plugins, true ) ) {
			WCFM::run();
		}
	}
