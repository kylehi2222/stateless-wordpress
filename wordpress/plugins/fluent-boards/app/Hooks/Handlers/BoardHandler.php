...
//        Task::destroy($taskIdsByBoard);
    ...
    public function boardStageUpdated($boardId, $newStageLabel, $oldStageLabel)
    {
    ...
    public function boardStageArchived($boardId, $stageTitle)
    {
    ...
    public function boardMemberAdded($boardId, $memberName)
    {
        $this->createLogActivity($boardId,'added', 'member', $memberName, null, '');
    }
    ...
    public function boardLabelActivity($label, $action)
    {
        $column = 'label';
        $settings = [
