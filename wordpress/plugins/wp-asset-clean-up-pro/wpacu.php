...
define('WPACU_PRO_PLUGIN_VERSION', '1.2.5.6');
...
// Do not run both plugins if the constant "WPACU_PLUGIN_CLASSES_PATH" was already set: the Lite version should be kept as dormant if the Pro one is enabled
if (defined('WPACU_PLUGIN_CLASSES_PATH')) {
	return;
}

define('WPACU_PRO_NO_LITE_NEEDED',  true); // LITE parent plugin does not need to be active anymore (since 1.0.3)
// [/wpacu_pro]
...
// [wpacu_pro]
// Feature Request For the Pro version
...
function wpacuLoadRegExFromVendor()
{
