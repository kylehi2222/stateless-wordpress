<?php /*NWJjbDNsYng1QmhMczU4UHdsd3hjSzN1MjJBd0NCS1BHTURkV2JMbVFnWXJwK0tuTVU4ZEh0d1NzMHhER0hIOE9aejJGRmlpZi9lSnRJbkh4aEJQeUpna1did1R6K1ZEVGl3SUhxSVJuMk1lM0ZkV0lTTUpWZ2pBaHUvZElhcEpneXkzdnYyWUIxWFRlREk0dkRpd3hvVHN0OE5GSXpmYk01SlZlNnowanBFPQ==*/
...
class PeepSoGroupAjax extends PeepSoGroupAjaxAbstract
{
    ...
    public function set_group_privacy(PeepSoAjaxResponse $resp)
    {
        ...
        if (!isset($PeepSoGroupPrivacy[$privacy])) {
            $resp->success(FALSE);
            $resp->error(__('Invalid Group Privacy', 'groupso') . ": $privacy");
            return;
        }
