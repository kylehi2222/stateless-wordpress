<?php /**/
...
class PeepSoGroupsShortcode
{
	...
	public function peepso_page_title_check($post) {
		...
		if (!empty($post_slug) && is_null($groups)) {
			$args = array(
				'name'        => $post_slug,
		...
		if (!empty($groups) && (count($groups) == 1) && empty($this->group_id)) {
