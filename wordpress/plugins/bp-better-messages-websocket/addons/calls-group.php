...
if ( !class_exists( 'Better_Messages_Calls_Group' ) ):
    ...
    class Better_Messages_Calls_Group
    {
        ...
        public function call_start( WP_REST_Request $request ){
            ...
            $request = [
                ...
                'meta'       => json_encode([
                    ...
                    'avatar' => Better_Messages_Functions()->get_rest_avatar($user->ID),
            ...
            $video_management_server = apply_filters( 'bp_better_messages_realtime_server', 'https://realtime-cloud.bpbettermessages.com/' );
        ...
        public function thread_group_call_admin( WP_REST_Request $request ){
            ...
            $video_cloud_server = apply_filters( 'better_messages_video_server', 'video-cloud.bpbettermessages.com' );
            $can_moderate = Better_Messages()->functions->is_thread_super_moderator( $user_id, $thread_id );
