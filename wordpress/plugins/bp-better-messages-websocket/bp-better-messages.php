    ...
    class Better_Messages {
        ...
        public function setup_classes() {
            ...
            if ( bpbm_fs()->is__premium_only() ) {
                if ( defined( 'BM_DEV' ) && file_exists( $this->path . 'inc/mobile-app/mobile-app.php' ) && Better_Messages()->functions->can_use_premium_code_premium_only() ) {
        ...
        public function get_script_variables() {
            ...
            if ( bpbm_fs()->is__premium_only() ) {
                ...
                if ( $this->realtime ) {
                    $socket_server = apply_filters( 'better_messages_realtime_server', apply_filters( 'bp_better_messages_realtime_server', 'https://realtime-cloud.bpbettermessages.com/' ) );
                    $turn_server = apply_filters( 'better_messages_turn_server', 'turn.bpbettermessages.com' );
                    $video_server = apply_filters( 'better_messages_video_server', 'video-cloud.bpbettermessages.com' );
