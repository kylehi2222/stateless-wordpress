...
if ( !class_exists( 'Better_Messages_Mobile_App_Scripts' ) ):
    ...
    class Better_Messages_Mobile_App_Scripts
    {
        ...
        public function get_last_assets()
        {
            ...
            $script_variables['mobile'] = [
                'loginLogo' => get_option('better-messages-app-settings-file-loginLogo', ''),
                'loginLogoExtension' => get_option('better-messages-app-settings-file-loginLogo-extension', '')
            ];
            ...
            foreach( wp_styles()->to_do as $handle ) {
                ...
                if( isset($_style->extra['after']) ){
                    $style['extra']['after'] = $_style->extra['after'];
        ...
        public function sync_scripts(): array
        {
