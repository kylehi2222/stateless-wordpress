...
<div class="content-area">
    ...
    <button id="delete-all-posts" class="button button-primary" title="Clear All Tasks" style="display: flex; align-items: center;color: #fff;background: #df0707;border-color: #df0707;">
        ...
        <span><?php echo esc_html__('Clear All', 'gpt3-ai-content-generator'); ?></span>
    </button>

    <button id="delete-completed-posts" class="button button-primary" title="Clear Completed Tasks" style="display: flex; align-items: center;color: #fff;background: #df0707;border-color: #df0707;">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2" style="vertical-align: middle; margin-right: 4px;">
            <polyline points="3 6 5 6 21 6"></polyline>
            <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
            <line x1="10" y1="11" x2="10" y2="17"></line>
        ...
        <span><?php echo esc_html__('Clear Completed', 'gpt3-ai-content-generator'); ?></span>
    </button>
...
<script>
    jQuery(document).ready(function($) {
        ...
        // Handle delete completed button click
        $('#delete-completed-posts').on('click', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#paginated-table tbody').empty(); // Clear the table contents or update the UI as needed
                        // reload the table
