    ...
    <form action="" method="post">
        ...
        <section>
            ...
            <div class="advanced-settings" id="toggleSDSettings" data-target="sd-settings-container">
                <?php echo esc_html__('Stable Diffusion', 'gpt3-ai-content-generator')?>
            </div>
            ...
            <div class="sd-settings-container" style="display: none;">
                ...
                <div class="unique-page-container">
                    <div class="nice-form-group">
                        ...
                        <a href="https://replicate.com/stability-ai/stable-diffusion/versions" target="_blank"><?php echo esc_html__('Get Version','gpt3-ai-content-generator')?></a>
                    </div>
                </div>
            </div>
