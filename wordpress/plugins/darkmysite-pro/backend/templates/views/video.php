<div id="darkmysite_video" style="display: none;">
    ...
    <div class="darkmysite_body_header">
        <div class="darkmysite_body_header_details">
            <div class="darkmysite_body_header_details_logo darkmysite_ignore">
                <img src="<?php echo esc_url(DARKMYSITE_PRO_IMG_DIR . "sidebar/sidebar_menu_video.svg") ?>">
            </div>
    ...
    <div class="darkmysite_section_block">
        <div class="darkmysite_video_replace_setting">
            <?php
            $darkmysite_video_replacements = json_decode($settings["video_replacements"], false);
            $darkmysite_video_replacements_count = 0;
            if(is_array($darkmysite_video_replacements)){
                foreach ($darkmysite_video_replacements as $single_video) {
                    ?>
                    ...
                    <div class="darkmysite_video_replace_setting_item">
                        <div class="darkmysite_video_replace_setting_item_part_0">
                            ...
                            <input type="text" value="<?php echo esc_attr($single_video->normal_video) ?>" placeholder="Video URL">
                        </div>
                        ...
                        <div class="darkmysite_video_replace_setting_item_part_2">
                            ...
                            <input type="text" value="<?php echo esc_attr($single_video->dark_video) ?>" placeholder="Video URL">
                        </div>
                        <div class="darkmysite_video_replace_setting_item_part_3">
                            <button class="choose_video darkmysite_ignore" onclick="darkmysite_video_replacement_choose_video(this)"></button>
                        </div>
                        <div class="darkmysite_video_replace_setting_item_part_4">
                            <?php if($darkmysite_video_replacements_count == 0){ ?>
                                <button class="add_item darkmysite_ignore" onclick="darkmysite_video_replacement_add_item()"></button>
                            <?php }else{ ?>
                    ...
                    <?php
                    $darkmysite_video_replacements_count++;
                }
            }
            ?>
