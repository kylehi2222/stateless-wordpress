<div id="darkmysite_preset" style="display: none;">
    ...
    <div class="darkmysite_body_header">
        <div class="darkmysite_body_header_details">
            <div class="darkmysite_body_header_details_logo darkmysite_ignore">
                <img src="<?php echo esc_url(DARKMYSITE_PRO_IMG_DIR . "sidebar/sidebar_menu_preset.svg") ?>">
            </div>
    ...
    <div class="darkmysite_section_block">
        <div class="darkmysite_preset_items darkmysite_dark_mode_color_preset" data-preset_id="<?php echo esc_attr($settings["dark_mode_color_preset"]) ?>">
            <div class="darkmysite_preset_item" onclick="darkmysite_color_preset_click(this, `black`)">
                <img src="<?php echo esc_url(DARKMYSITE_PRO_IMG_DIR . "preset/black.png") ?>">
            ...
            <div class="darkmysite_preset_item" onclick="darkmysite_color_preset_click(this, `blue`)">
                <img src="<?php echo esc_url(DARKMYSITE_PRO_IMG_DIR . "preset/blue.png") ?>">
            ...
            <div class="darkmysite_preset_item" onclick="darkmysite_color_preset_click(this, `green`)">
                <img src="<?php echo esc_url(DARKMYSITE_PRO_IMG_DIR . "preset/green.png") ?>">
            ...
            <div class="darkmysite_preset_item" onclick="darkmysite_color_preset_click(this, `orange`)">
                <img src="<?php echo esc_url(DARKMYSITE_PRO_IMG_DIR . "preset/orange.png") ?>">
            ...
            <div class="darkmysite_preset_item" onclick="darkmysite_color_preset_click(this, `pink`)">
                <img src="<?php echo esc_url(DARKMYSITE_PRO_IMG_DIR . "preset/pink.png") ?>">
    ...
    <div class="darkmysite_section_block">
        ...
        <div class="darkmysite_section_block_separator"></div>
        <div class="darkmysite_input_select_setting darkmysite_dark_mode_link_color">
            <div class="darkmysite_input_select_setting_details">
                <h4>Link Color</h4>
        ...
        <div class="darkmysite_section_block_separator"></div>
        <div class="darkmysite_input_select_setting darkmysite_dark_mode_link_hover_color">
            <div class="darkmysite_input_select_setting_details">
        ...
        <div class="darkmysite_section_block_separator"></div>
        <div class="darkmysite_input_select_setting darkmysite_dark_mode_input_bg">
            <div class="darkmysite_input_select_setting_details">
        ...
        <div class="darkmysite_section_block_separator"></div>
        <div class="darkmysite_input_select_setting darkmysite_dark_mode_input_text_color">
            <div class="darkmysite_input_select_setting_details">
        ...
        <div class="darkmysite_section_block_separator"></div>
        <div class="darkmysite_input_select_setting darkmysite_dark_mode_input_placeholder_color">
            <div class="darkmysite_input_select_setting_details">
        ...
        <div class="darkmysite_section_block_separator"></div>
        <div class="darkmysite_input_select_setting darkmysite_dark_mode_border_color">
            <div class="darkmysite_input_select_setting_details">
                <h4>Border Color</h4>
        ...
        <div class="darkmysite_section_block_separator"></div>
        <div class="darkmysite_input_select_setting darkmysite_dark_mode_btn_bg">
            <div class="darkmysite_input_select_setting_details">
        ...
        <div class="darkmysite_section_block_separator"></div>
        <div class="darkmysite_input_select_setting darkmysite_dark_mode_btn_text_color">
            <div class="darkmysite_input_select_setting_details">
    ...
    <div class="darkmysite_section_block">
        ...
        <div class="darkmysite_input_select_setting darkmysite_dark_mode_scrollbar_track_bg" style="<?php echo esc_attr(strpos($settings["enable_scrollbar_dark"], "1") !== false ? "" : "display: none;") ?>">
            <div class="darkmysite_input_select_setting_details">
        ...
        <div class="darkmysite_section_block_separator" style="<?php echo esc_attr(strpos($settings["enable_scrollbar_dark"], "1") !== false ? "" : "display: none;") ?>"></div>
        <div class="darkmysite_input_select_setting darkmysite_dark_mode_scrollbar_thumb_bg" style="<?php echo esc_attr(strpos($settings["enable_scrollbar_dark"], "1") !== false ? "" : "display: none;") ?>">
            <div class="darkmysite_input_select_setting_details">
