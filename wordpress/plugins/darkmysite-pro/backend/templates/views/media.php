<div id="darkmysite_media" style="display: none;">
    ...
    <div class="darkmysite_body_header">
        <div class="darkmysite_body_header_details">
            <div class="darkmysite_body_header_details_logo darkmysite_ignore">
                <img src="<?php echo esc_url(DARKMYSITE_PRO_IMG_DIR . "sidebar/sidebar_menu_image.svg") ?>">
            </div>
    ...
    <div class="darkmysite_section_block">
        <div class="darkmysite_checkbox_input_select_setting darkmysite_has_textarea darkmysite_enable_low_image_brightness">
            ...
            <div class="darkmysite_checkbox_input_select_setting_part_2" style="<?php echo esc_attr($settings["enable_low_image_brightness"] == "1" ? "" : "display: none;") ?>">
                <textarea placeholder="Exclude low brightness on specific images." rows="2"><?php echo esc_attr($settings["disallowed_low_brightness_images"]) ?></textarea>
        ...
        <div class="darkmysite_checkbox_input_select_setting darkmysite_has_textarea darkmysite_enable_image_grayscale">
            ...
            <div class="darkmysite_checkbox_input_select_setting_part_2" style="<?php echo esc_attr($settings["enable_image_grayscale"] == "1" ? "" : "display: none;") ?>">
                <textarea placeholder="Exclude grayscale on specific images." rows="2"><?php echo esc_attr($settings["disallowed_grayscale_images"]) ?></textarea>
    ...
    <div class="darkmysite_section_block">
        <div class="darkmysite_checkbox_setting darkmysite_enable_invert_images">
            <label class="darkmysite_checkbox_item darkmysite_ignore"><input type="checkbox" <?php echo esc_attr($settings["enable_invert_images"] == "1" ? "checked" : "") ?>><span class="darkmysite_checkbox_checkmark"></span></label>
            <div class="darkmysite_checkbox_setting_details">
                <h4>Invert Images</h4>
                <p>Check to invert specific images on dark mode.</p>
            </div>
        </div>
        <div class="darkmysite_textarea_setting darkmysite_invert_images_allowed_urls">
            <textarea placeholder="Image URLs on IMG tag and CSS backgrounds are supported.&#10;Example:&#10;https://example.com/wp-content/uploads/2022/12/1.jpg&#10;https://example.com/2.svg" rows="6"><?php echo esc_attr(implode('&#10;', json_decode($settings["invert_images_allowed_urls"], false))) ?></textarea>
    ...
    <div class="darkmysite_section_block">
        <div class="darkmysite_image_replace_setting">
            <?php
            $darkmysite_image_replacements = json_decode($settings["image_replacements"], false);
            $darkmysite_image_replacements_count = 0;
            if(is_array($darkmysite_image_replacements)){
                foreach ($darkmysite_image_replacements as $single_image) {
                    ?>
                    ...
                    <div class="darkmysite_image_replace_setting_item">
                        <div class="darkmysite_image_replace_setting_item_part_0">
                            ...
                            <input type="text" value="<?php echo esc_attr($single_image->normal_image) ?>" placeholder="Image URL">
                        </div>
                        ...
                        <div class="darkmysite_image_replace_setting_item_part_2">
                            ...
                            <input type="text" value="<?php echo esc_attr($single_image->dark_image) ?>" placeholder="Image URL">
                        </div>
                        <div class="darkmysite_image_replace_setting_item_part_3">
                            <button class="choose_image darkmysite_ignore" onclick="darkmysite_image_replacement_choose_image(this)"></button>
                        </div>
                        <div class="darkmysite_image_replace_setting_item_part_4">
                            <?php if($darkmysite_image_replacements_count == 0){ ?>
                                <button class="add_item darkmysite_ignore" onclick="darkmysite_image_replacement_add_item()"></button>
                            <?php }else{ ?>
                    ...
                    <?php
                    $darkmysite_image_replacements_count++;
                }
            }
            ?>
