...
class HMWP_Classes_Tools
{
    ...
    public static function getOptions( $safe = false )
    {
        ...
        self::$default = array(
            ...
            'hmwp_hide_commonfiles_files' => array('wp-config-sample.php', 'readme.html', 'readme.txt', 'install.php', 'license.txt', 'php.ini', 'upgrade.php', 'bb-config.php', 'error_log', 'debug.log'),
            //
            'hmwp_category_base' => '',
            'hmwp_tag_base' => '',
            //
