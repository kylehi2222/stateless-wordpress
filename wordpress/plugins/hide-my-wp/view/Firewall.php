                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-12 row border-bottom border-light px-2 py-2 mx-0 my-3 border-bottom hmwp_geoblock">
                                ...
                                <div class="col-sm-8 p-0 mb-1">
                                    <select name="hmwp_geoblock_countries[]" class="form-control bg-input selectpicker" multiple data-live-search="true">
                                        <?php
                                        ...
                                        foreach ($countries as $code => $country){
                                            echo '<option value="'.$code.'" '.selected(true, in_array($code, (array)$blocked_countries)).'>'.$country.'</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-12 row border-bottom border-light py-3 px-2 mx-1 my-3 hmwp_geoblock">
                                ...
                                <div class="col-md-8 p-0 input-group input-group">
                                    <?php
                                    $urls = HMWP_Classes_Tools::getOption('hmwp_geoblock_urls');
                                    if(!empty($urls)){
                                        $urls = json_decode($urls, true);
                                    }
                                    ?>
                                    <textarea type="text" class="form-control bg-input" name="hmwp_geoblock_urls" style="height: 100px"><?php echo(!empty($urls) ? implode(PHP_EOL, $urls) : '') ?></textarea>
                                        ...
                                        <ul class="row">
                                            ...
                                            foreach ($countries as $code => $country){
                                                if(in_array($code, $blocked_countries)){
                                                    echo '<li class="font-weight-bold '.(count((array)$blocked_countries) > 6 ? 'col-4' : 'col-12').'">'.$country.'</li>';
                                                }
                                            }
                                            ?>
                                        </ul>
