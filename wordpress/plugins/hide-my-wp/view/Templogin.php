                            ...
                            <div class="checker col-sm-12 row my-2 py-1">
                                <div class="col-sm-12 p-0 switch switch-sm">
                                    ...
                                    <label for="hmwp_templogin"><?php echo esc_html__('Use Temporary Logins', 'hide-my-wp'); ?>
                                        <a href="<?php echo HMWP_Classes_Tools::getOption('hmwp_plugin_website') ?>/kb/temporary-logins/#temporary_login_settings" target="_blank" class="d-inline ml-1"><i class="dashicons dashicons-editor-help d-inline"></i></a>
                                    </label>
