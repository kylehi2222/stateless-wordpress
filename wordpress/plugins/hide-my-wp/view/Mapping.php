        ...
        <div class="hmwp_col flex-grow-1 px-3 py-3 mr-2 mb-3 bg-white">
            ...
            <form method="POST">
                ...
                <div id="text" class="card col-sm-12 p-0 m-0 tab-panel tab-panel-first">
                        ...
                        <?php } else { ?>
                            ...
                            <div class="col-sm-12border-bottom border-light py-3 mx-0 ">
                                <div class="p-0">
                                    <div class="text-black-50 small"><?php echo esc_html__('Replace the text in tags and classes to hide any WordPress footprint.', 'hide-my-wp'); ?></div>
                ...
                <div id="url" class="card col-sm-12 p-0 m-0 tab-panel">
                        ...
                        <?php } else { ?>
                            <div class="card-body">
                            <div class="text-black-50 small"><?php echo esc_html__("You can add a list of URLs you want to change into new ones.", 'hide-my-wp'); ?></div>
                            <div class="my-2 p-2 alert-danger">
                ...
                <div id="cdn" class="card col-sm-12 p-0 m-0 tab-panel">
                    ...
                    <?php } else { ?>
                        <div class="card-body">
                        <div class="text-black-50 small"><?php echo esc_html__("You can add one or more CDN URLs you use.", 'hide-my-wp'); ?></div>
                            ...
                            <div class="col-sm-12 row mb-1 ml-1 p-2">
                                <div class="checker col-sm-12 row my-2 py-1">
                                    <div class="col-sm-12 p-0 switch switch-sm switch-red">
                                        ...
                                        <div class="mt-1 ml-5 p-2 alert-danger"><?php echo esc_html__("If you switch this option on, it will significantly slow down the website as CSS and JS files are loaded dynamically and not through rewrites to be able to change the text within all of them", 'hide-my-wp'); ?></div>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
