...
class HMWP_Controllers_Overview extends HMWP_Classes_FrontController
{
    ...
    public function getFeatures()
    {
        $features = array(
            ...
            array(
                'title' => esc_html__("Magic Link Login", 'hide-my-wp') . ' (New)',
            ...
            array(
                'title' => esc_html__("Woocommerce Magic Link", 'hide-my-wp') . ' (New)',
            ...
            array(
                'title' => esc_html__("Country Blocking", 'hide-my-wp') . ' (New)',
