<?php namespace RealTimeAutoFindReplacePro\admin\builders;
...
use RealTimeAutoFindReplace\admin\builders\AdminPageBuilder as MainAdminPageBuilder;
...
class AdminPageBuilder {
	...
	private function getClass( $class ) {
		$class_path = '\RealTimeAutoFindReplacePro\\admin\\options\\pages\\' . $class;
	...
	public function generate_page( $argc ) {
		...
		return ( new MainAdminPageBuilder() )->generate_page( $argc );
		...
		// $MainAdminPageBuilder = new MainAdminPageBuilder();

		// return \sprintf(
		// $MainAdminPageBuilder->page_wrapper( $argc ),
		// $this->page_wrapper( $argc ),
		// $this->generate_header( $argc ),
		// $MainAdminPageBuilder->generate_header( $argc ),
		// $content,
		// $MainAdminPageBuilder->generate_button_block( $argc ),
		// $this->generate_button_block( $argc ),
		// $this->generate_footer()
		// $MainAdminPageBuilder->generate_footer()
		// );
	}
