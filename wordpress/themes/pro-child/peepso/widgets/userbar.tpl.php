...
?>
    <div class="psw-userbar psw-userbar--<?php echo $position; ?> ps-js-widget-userbar <?php echo $compact_mode_string;?>">
        ...
        <div style="margin-right: 10px; margin-left: 10px;"><?php echo do_shortcode('[darkmysite switch="1" width_height="1.1rem" border_radius="7px" icon_width="7px" light_mode_bg="#222" dark_mode_bg="#ffffff" light_mode_icon_color="#ffffff" dark_mode_icon_color="#222"]'); ?></div>
        <?php
        ...
        <div class="psw-userbar__user-profile">
          ...
          <div class="ps-avatar psw-avatar--userbar">
            <a href="<?php echo $user->get_profileurl();?>">
              <img style="width: 33px !important;" src="<?php echo $user->get_avatar();?>" alt="<?php echo $user->get_fullname();?> avatar" title="<?php echo $user->get_profileurl();?>">
            </a>
          </div>
          <?php } ?>
