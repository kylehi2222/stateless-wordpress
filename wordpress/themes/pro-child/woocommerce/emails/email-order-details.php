 ...
 *
 * @author  themes.email
 * @url     yourtheme/woocommerce/emails/email-order-details.php
		...
		<tfoot>
			...
			if ( $totals ) {
				...
				foreach ( $totals as $total ) {
					...
					?>
					<tr>
						<th class="td" scope="row" colspan="2" style="text-align: right; <?php echo ( 1 === $i ) ? 'border-top-width: 0px;' : ''; ?>"><?php echo wp_kses_post( $total['label'] ); ?></th>
