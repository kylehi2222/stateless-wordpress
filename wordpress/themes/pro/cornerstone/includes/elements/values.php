...
cs_define_values('toggleable', [
  'content_dynamic_rendering'     => cs_value( false, 'markup' ),
  'esc_key_close'                 => cs_value( false, 'markup' ),
  'direct_close'                  => cs_value( true, 'markup' ),
]);
...
cs_define_values( 'image', array(
  ...
  'image_attachment_srcset'     => cs_value( false, 'markup' ),
...
cs_define_values( '_search', array(
  ...
  'search_autofocus'                    => cs_value( true, 'markup' ),
...
cs_define_values( 'omega:looper-provider', array(
  ...
  'looper_provider_query-builder_meta_values' => cs_value( '', 'markup' ),
  ...
  'looper_provider_array_loop_keys'      => cs_value( false, 'markup' ),
...
cs_define_values( 'bg-layer', [
  ...
  'color'               => cs_value( 'rgba(255, 255, 255, 0.5)', 'markup' ),
  'image'               => cs_value( '', 'markup:img', true ),
  'image_repeat'        => cs_value( 'no-repeat', 'markup', true ),
  'image_size'          => cs_value( 'cover', 'markup', true ),
  'image_position'      => cs_value( 'center', 'markup', true ),
  'img_src'             => cs_value( '', 'markup:img', true ),
  'img_alt'             => cs_value( '', 'markup', true ),
  'img_object_fit'      => cs_value( 'cover', 'markup', true ),
  'img_object_position' => cs_value( 'center', 'markup', true ),
  'img_attachment_srcset' => cs_value( false, 'markup', true ),
  'video'               => cs_value( '', 'markup', true ),
  'video_poster'        => cs_value( '', 'markup', true ),
  'video_loop'          => cs_value( true, 'markup' ),
  'video_pause_out_of_view' => cs_value( false, 'markup' ),
  'custom_content'      => cs_value( '', 'markup', true ),
  'custom_aria_hidden'  => cs_value( true, 'markup', true ),
  'parallax'            => cs_value( false, 'markup' ),
  'parallax_size'       => cs_value( '150%', 'markup' ),
  'parallax_direction'  => cs_value( 'v', 'markup' ),
  'parallax_reverse'    => cs_value( false, 'markup' ),
]);
...
cs_define_values( 'dropdown', cs_compose_values(
  ...
  [
    ...
    'dropdown_display_inline'        => cs_value( false, 'markup' ),
...
cs_define_values( 'mejs', array(
  ...
  'mejs_pause_out_of_view'                        => cs_value( false, 'markup' ),
  'mejs_playsinline'                              => cs_value( false, 'markup' ),
...
cs_define_values( 'modal', cs_compose_values(
  ...
  [
    ...
    'modal_close_enabled'                 => cs_value( true, 'markup' ),
...
cs_define_values( 'off-canvas', cs_compose_values(
  ...
  [
    ...
    'off_canvas_close_enabled'                 => cs_value( true, 'markup' ),
